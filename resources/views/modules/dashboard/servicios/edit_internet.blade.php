    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1>Editar Servicio de Internet</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('tipo') is-invalid @enderror" id="tipo" name="tipo" required>
                                    ...
                                    <option value="Empresarial" {{ old('tipo', $servicio->tipo) == 'Empresarial' ? 'selected' : '' }}>Empresarial</option>
                                    <option value="Dedicado" {{ old('tipo', $servicio->tipo) == 'Dedicado' ? 'selected' : '' }}>Dedicado</option>
                                </select>
                                @error('tipo')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
