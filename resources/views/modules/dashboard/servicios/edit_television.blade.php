    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1>Editar Servicio de Televisión</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('tipo') is-invalid @enderror" id="tipo" name="tipo" required>
                                    <option value="Básico" {{ old('tipo', $servicio->tipo) == 'Básico' ? 'selected' : '' }}>Básico</option>
                                    <option value="Intermedio" {{ old('tipo', $servicio->tipo) == 'Intermedio' ? 'selected' : '' }}>Intermedio</option>
                                    <option value="Premium" {{ old('tipo', $servicio->tipo) == 'Premium' ? 'selected' : '' }}>Premium</option>
                                </select>
                                @error('tipo')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <!-- Límite Mínimo -->
                            <div class="col-md-6 mb-3">
                                <label for="limite_minimo" class="form-label">Límite Mínimo de Pago</label>
                            ...
                            <!-- Límite Máximo -->
                            <div class="col-md-6 mb-3">
                                <label for="limite_maximo" class="form-label">Límite Máximo de Pago</label>
                            ...
                            <!-- Máxima Afiliación -->
                            <div class="col-md-6 mb-3">
                                <label for="maxima_afiliacion" class="form-label">Máxima Cantidad de Afiliaciones</label>
